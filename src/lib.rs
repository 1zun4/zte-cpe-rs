...
use commands::{
    AdCommand, BearerPreference, BearerPreferenceCommand, ConnectNetworkCommand, ConnectionMode,
    ConnectionModeCommand, DisconnectNetworkCommand, DnsModeCommand, GoformCommand,
    LockLteBandCommand, LoginCommand, LogoutCommand, RebootCommand, UpnpCommand,
};
use log::debug;
...
impl ZteClient {
    ...
    pub async fn set_network_bearer_preference(
        &self,
